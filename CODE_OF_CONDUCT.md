...
- Focus discussion on code, product behavior, and user impact.

## Unacceptable Behavior

- Harassment, threats, or discriminatory language.
- Trolling, personal attacks, or derailing technical discussion.
- Publishing private information without permission.
- Repeated disruptive behavior after moderation requests.

## Enforcement

Maintainers may remove, edit, or reject comments, commits, issues,
and contributions that violate this Code of Conduct.
