...
export function DownloadSection({ onDownload }: { onDownload: () => void }) {
  ...
  useEffect(() => {
    const id = window.setTimeout(() => {
      const apkUrl = new URL('/journeysync.apk?v=1.2.2', window.location.origin).href;
      setQrSrc(
        ...
        >
          ...
          <div className="download-qr">
            <div className="download-qr-phone">
              <a href="/journeysync.apk?v=1.2.2" download aria-label="Scan to download JourneySync APK">
                {qrSrc ? (
