...
export function DownloadSection({ onDownload }: { onDownload: () => void }) {
  ...
  useEffect(() => {
    const id = window.setTimeout(() => {
      const apkUrl = new URL('/journeysync.apk?v=1.2.3', window.location.origin).href;
      setQrSrc(
        ...
        >
          ...
          <div className="download-qr">
            <div className="download-qr-phone">
              <a href="/journeysync.apk?v=1.2.3" download aria-label="Scan to download JourneySync APK">
                {qrSrc ? (
